...
import org.mewx.topcoder.problems.SnowyWinter;
...
public class SnowyWinterTest {
    @Test
    public void snowyHighwayLength() throws Exception {
        List<ParsedResultMeta> parsedResultMeta = TestUtils.parseTestData(TestUtils.getFileContentById(8620));
    ...
    private int call(String src) {
        return new SnowyWinter().snowyHighwayLength(BuiltinParser.parseToIntArray(src.substring(0, src.indexOf("}") + 1)),
