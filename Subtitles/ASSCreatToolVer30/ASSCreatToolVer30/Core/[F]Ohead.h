...
static void Ohead(ScriptInfo TempScriptInfo)//输入完成后，将i改为-1
{
	short jjjjj=0;
	...
	ass_out<<";Programme Version: "<<Version<<endl;
	...
	ass_out<<"Format: Name, Fontname, Fontsize, PrimaryColour, SecondaryColour, OutlineColour, BackColour, Bold, Italic, Underline, StrikeOut, ScaleX, ScaleY, Spacing, Angle, BorderStyle, Outline, Shadow, Alignment, MarginL, MarginR, MarginV, Encoding"<<endl;
	for(jjjjj=0; jjjjj<TempScriptInfo.FontAmount; jjjjj++)
	{
		ass_out<<"Style:"<<TempScriptInfo.FontInfo[jjjjj].Name<<','<<TempScriptInfo.FontInfo[jjjjj].Fontname<<','<<TempScriptInfo.FontInfo[jjjjj].Fontsize<<",&H"<<TempScriptInfo.FontInfo[jjjjj].PrimaryColour<<",&H"<<TempScriptInfo.FontInfo[jjjjj].SecondaryColour<<",&H"<<TempScriptInfo.FontInfo[jjjjj].OutlineColour<<",&H"<<TempScriptInfo.FontInfo[jjjjj].BackColour<<','<<TempScriptInfo.FontInfo[jjjjj].Bold<<','<<TempScriptInfo.FontInfo[jjjjj].Italic<<','<<TempScriptInfo.FontInfo[jjjjj].Underline<<','<<TempScriptInfo.FontInfo[jjjjj].StrikeOut<<','<<TempScriptInfo.FontInfo[jjjjj].ScaleX<<','<<TempScriptInfo.FontInfo[jjjjj].ScaleY<<','<<TempScriptInfo.FontInfo[jjjjj].Spacing<<','<<TempScriptInfo.FontInfo[jjjjj].Angle<<','<<TempScriptInfo.FontInfo[jjjjj].BorderStyle<<','<<TempScriptInfo.FontInfo[jjjjj].Outline<<','<<TempScriptInfo.FontInfo[jjjjj].Shadow<<','<<TempScriptInfo.FontInfo[jjjjj].Alignment<<','<<TempScriptInfo.FontInfo[jjjjj].MarginL<<','<<TempScriptInfo.FontInfo[jjjjj].MarginR<<','<<TempScriptInfo.FontInfo[jjjjj].MarginV<<','<<TempScriptInfo.FontInfo[jjjjj].Encoding<<endl;
	}
